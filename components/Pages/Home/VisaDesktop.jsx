  ...
  <section ref={sectionRef} className="hidden lg:block">
    ...
    <div className="min-h-screen flex items-center">
      ...
      <div className="container-main w-full">
        ...
        <div className="!mb-12 max-[1535px]:!mb-8">

          <p className="text-sm uppercase tracking-[3px] text-gray-500 !mb-3 max-[1535px]:text-xs max-[1535px]:!mb-2">
            Global Visa Options
          </p>
        ...
        <div className="flex items-center gap-16 max-[1535px]:gap-5">
